<?xml version="1.0" encoding="UTF-8"?><sld:StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" version="1.0.0">
    <sld:UserLayer>
        ...
        <sld:UserStyle>
            <sld:Name>provincias geo</sld:Name>
            <sld:FeatureTypeStyle>
                ...
                <sld:Rule>
                    ...
                    <sld:MaxScaleDenominator>5500000.0</sld:MaxScaleDenominator>
                    ...
                    <sld:TextSymbolizer>
                        ...
                        <sld:Halo>
                            ...
                            <sld:Fill>
                                <sld:CssParameter name="fill">#EDD400</sld:CssParameter>
                            </sld:Fill>
                        </sld:Halo>
                        <sld:Fill>
                            <sld:CssParameter name="fill">#2E3436</sld:CssParameter>
                        </sld:Fill>
                    </sld:TextSymbolizer>
                </sld:Rule>
                <sld:Rule>
